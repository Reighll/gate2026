...
<?= $this->section('content') ?>
    <div class="pt-5 mt-4">
        ...
        <div class="card border-0 shadow-sm rounded-4 mb-4">
            <div class="card-body p-3 p-md-4">
                <h5 class="fw-bold text-dark mb-4"><i class="ti ti-clock-hour-4 me-2 text-warning"></i> Pending Reports</h5>
                            ...
                            <tr>
                                <td colspan="5" class="text-center">
                                    <div class="d-flex flex-column align-items-center justify-content-center py-5 w-100">
                                        ...
                                        <p class="mb-0 text-muted">No pending reports. All caught up!</p>
                                    </div>
                                </td>
                            </tr>
                        <?php else: ?>
                            <?php foreach($pendingReports as $report): ?>
                                <tr>
                                    ...
                                    <td data-label="Action"><button class="btn btn-primary btn-sm rounded-pill" data-bs-toggle="modal" data-bs-target="#viewModalPending<?= $report['id'] ?>">VIEW</button></td>
                                    <td data-label="Status"><span class="badge bg-warning text-dark rounded-pill">FLAGGED</span></td>
                                </tr>
                            <?php endforeach; ?>
                        <?php endif; ?>
                        </tbody>
        ...
        <?php if(!empty($pendingReports)): ?>
            <?php foreach($pendingReports as $report): ?>
                <div class="modal fade" id="viewModalPending<?= $report['id'] ?>" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content border-0 rounded-4 shadow">
                            ...
                            <div class="modal-footer border-0 justify-content-center pb-4">
                                <form hx-disable action="<?= base_url('admin/item-reports/approve/' . $report['id']) ?>" method="post">
                                    <?= csrf_field() ?>
                                    <button type="submit" class="btn btn-danger px-4 py-2 rounded-pill fw-semibold text-white shadow-sm" style="border:none;">
                                        <i class="ti ti-check me-1"></i> APPROVE REPORT
                                    </button>
                                </form>
                            </div>
                        </div>
