            ...
            <form action="<?= base_url('admin/users/createStudent') ?>" method="post">
                ...
                <div class="modal-body px-4 py-3">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control form-control-lg rounded-3 bg-light shadow-none" style="border: 1px solid #eef2f6;" name="student_number" placeholder="TUPT-23-0001" required>
                    </div>
                    <div class="row">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control form-control-lg rounded-3 bg-light shadow-none" style="border: 1px solid #eef2f6;" name="email" placeholder="juan.delacruz@tup.edu.ph">
                    </div>
                    <div class="mb-3">
                ...
                <div class="modal-footer border-top-0 px-4 pb-4 pt-2 d-grid gap-2 d-sm-flex justify-content-sm-end">
                    ...
                    <button type="submit" class="btn btn-primary fw-bold px-4 py-2 shadow-sm m-0" style="border-radius: 10px; background-color: #5d87ff; border: none;">Create Student</button>
                </div>
            </form>
        </div>
    </div>
