            ...
            <form action="<?= base_url('admin/users/createStudent') ?>" method="post">
                ...
                <div class="modal-body px-4 py-3">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control form-control-lg rounded-3 input-adaptive shadow-none" name="student_number" placeholder="TUPT-23-0001" required>
                    </div>
                    <div class="row">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" class="form-control form-control-lg rounded-3 input-adaptive shadow-none" name="password" placeholder="••••••••" required>
                    </div>
                </div>
