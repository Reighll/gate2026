            ...
            <form action="<?= base_url('admin/users/editAdmin/' . $admin['id']) ?>" method="post">
                ...
                <div class="modal-body px-4 py-3">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control form-control-lg rounded-3 bg-light shadow-none" style="border: 1px solid #eef2f6;" name="username" value="<?= esc($admin['username']) ?>" required>
                    </div>
                    <div class="row">
                        <div class="col-sm-6 mb-3">
                            ...
                            <input type="text" class="form-control form-control-lg rounded-3 bg-light shadow-none" style="border: 1px solid #eef2f6;" name="first_name" value="<?= esc($admin['first_name']) ?>" required>
                        </div>
                        <div class="col-sm-6 mb-3">
                            ...
                            <input type="text" class="form-control form-control-lg rounded-3 bg-light shadow-none" style="border: 1px solid #eef2f6;" name="last_name" value="<?= esc($admin['last_name']) ?>" required>
                        </div>
                    </div>
                    <div class="mb-3">
