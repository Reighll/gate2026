<div class="modal fade sheet-modal" id="editAdminModal<?= $admin['id'] ?>" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered px-2 px-sm-0">
        <div class="modal-content border-0 shadow-lg" style="border-radius: 24px;">

            <form action="<?= base_url('admin/users/editAdmin/' . $admin['id']) ?>" method="post">
                <?= csrf_field() ?>
                ...
                <div class="modal-header border-bottom-0 pt-4 px-4 pb-2 d-flex justify-content-between align-items-center">
                    <h5 class="modal-title fw-bolder d-flex align-items-center mb-0 text-truncate pe-2">
                        <div class="rounded-circle d-flex align-items-center justify-content-center me-3 flex-shrink-0" style="width: 40px; height: 40px; background-color: rgba(228, 106, 118, 0.15); color: #e46a76;">
                ...
                <div class="modal-body px-4 py-3">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control form-control-lg rounded-3 input-adaptive shadow-none" name="username" value="<?= esc($admin['username']) ?>" required>
                    </div>
                    <div class="row">
                        <div class="col-sm-6 mb-3">
                            ...
                            <input type="text" class="form-control form-control-lg rounded-3 input-adaptive shadow-none" name="first_name" value="<?= esc($admin['first_name']) ?>" required>
                        </div>
                        <div class="col-sm-6 mb-3">
                            ...
                            <input type="text" class="form-control form-control-lg rounded-3 input-adaptive shadow-none" name="last_name" value="<?= esc($admin['last_name']) ?>" required>
                        </div>
                    </div>
                    <div class="mb-3">
                ...
                <div class="modal-footer border-top-0 px-4 pb-4 pt-2 d-flex justify-content-end modal-actions-mobile">
                    <button type="submit" class="btn btn-danger text-white fw-bold px-4 py-2 shadow-sm m-0" style="border-radius: 10px; border: none; background-color: #e46a76;">Save Changes</button>
                </div>
            </form>
        </div>
    </div>
