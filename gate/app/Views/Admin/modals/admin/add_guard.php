            ...
            <form action="<?= base_url('admin/users/createGuard') ?>" method="post">
                ...
                <div class="modal-body px-4 py-3">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control form-control-lg rounded-3 bg-light shadow-none" style="border: 1px solid #eef2f6;" name="username" placeholder="guard_juan" required>
                    </div>
                    <div class="row">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="position-relative">
                            <input type="password" class="form-control form-control-lg rounded-3 bg-light shadow-none pe-5" style="border: 1px solid #eef2f6;" name="password" placeholder="••••••••" required>
