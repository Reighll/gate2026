<header class="app-header">
    <nav class="navbar navbar-expand-lg navbar-light px-3">
        ...
        <a href="<?= base_url('admin/dashboard') ?>" class="d-flex align-items-center text-decoration-none ms-2">
            <img src="<?= base_url('assets/images/logos/favicon.png') ?>" alt="Gatepass Logo" width="35" height="35" class="me-2 drop-shadow-sm">
            <h4 class="mb-0 fw-bolder text-primary d-none d-sm-block" style="letter-spacing: 0.5px;">GATE <span class="text-dark">Admin</span></h4>
        </a>
        ...
        <?= esc(session()->get('admin_email')) ?? 'admin@tup.edu.ph' ?>
                    ...
                    <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up shadow-lg rounded-3 border-0"
                        ...
                        <div class="message-body">
                            ...
                            <a href="<?= base_url('admin/logout') ?>" class="d-flex align-items-center gap-2 dropdown-item px-4 py-2 text-danger">
