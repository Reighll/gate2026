...
<head>
    ...
    <title><?= $this->renderSection('title') ?? 'Admin Auth | Gatepass System' ?></title>
...
<a href="<?= base_url('/') ?>" class="btn btn-light btn-home-back shadow-sm rounded-pill position-absolute top-0 start-0 m-3 m-md-4 d-flex align-items-center gap-2 px-3 py-2 text-decoration-none fw-semibold" style="z-index: 999; backdrop-filter: blur(5px);">
