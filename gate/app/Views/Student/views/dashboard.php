...
<script>
    window.dashboardConfig = {
        showTermsModal: <?= !empty($showTermsModal) ? 'true' : 'false' ?>,
        acceptTermsUrl: '<?= base_url('student/accept-terms') ?>',
        csrfHeader: '<?= csrf_header() ?>',
        csrfHash: '<?= csrf_hash() ?>',
        tourStorageKey: 'hasSeenDashboardTour_<?= esc(session()->get('student_id')) ?>',
        itemRegistrationUrl: '<?= base_url('student/items/registration') ?>'
    };
</script>
